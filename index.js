...
const { Bella, tanggal, waktu, instagram, whatsapp, youtube, nomer, aktif, ontime } = config
...
client.on('message-new', async (m) => {
   ...
   switch (prefix) {
       case 'help':
           client.sendMessage(id, help.help(id, Bella, tanggal, whatsapp, youtube, instagram, nomer),MessageType.text)
           break      
      case 'donate':
           client.sendMessage(id, donate.donate(id, Bella, tanggal),MessageType.text)
           break          
      case 'info':
           client.sendMessage(id, info.info(id, Bella, tanggal),MessageType.text)
           break             
       case 'nulis':
           nulis(value)
               .then(data => {
